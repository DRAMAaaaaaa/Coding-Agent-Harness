...
| MVP-3 Task 8 | 最小单页 WebUI 与同源静态托管 | MVP-3 Task 7 | 独立 worktree | `codex/webui` | 整分支最终审查返工已完成（当前返工受审范围 `b376716..HEAD`）：API 404/405、计划/终审完整证据门禁、TaskEvent fail-closed 与权威治理 scope 均已补 RED→GREEN 回归；本 Task 无新增延期，待独立最终复审与本地合并 |
